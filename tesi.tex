...
% https://www.researchgate.net/profile/Edison_Pignaton_de_Freitas/publication/221003869_UAV_relay_network_to_support_WSN_connectivity/links/0deec525d7ace73789000000/UAV-relay-network-to-support-WSN-connectivity.pdf

Classicamente, nelle reti wireless, i client vengono considerati oggetti mobili mentre l'infrastruttura è assunta statica. In questo elaborato proponiamo invece un modello dove l'infrastruttura è nomadica: le stazioni radio base sono montate su veicoli che attraversano il territorio. Quest'idea nasce da una semplice osservazione: la frequenza di raccolta dati dai sensori è in generale molto bassa, limitandosi spesso ad un campione al giorno. È quindi superfluo installare dei Gateway fissi disponibili in ogni momento, è sufficiente che un veicolo di raccolta dati passi con una data frequenza in prossimità dei sensori.

Per aumentare ulteriormente la copertura viene utilizzato un routing ad-hoc: in caso di necessità, il messaggio vene ritrasmesso dai nodi della rete fino alla destinazione.
